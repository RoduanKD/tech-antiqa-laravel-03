...
')
     ...
     */ 
         ...
         * 
         *
         * @see \LaravelFrontendPresets\MaterialPreset\MaterialPresetServiceProvider::boot()
         * @param mixed $command
         * @static 
         */ 
        public static function material($command)
        {
                        return \Illuminate\Console\Command::material($command);
        }
